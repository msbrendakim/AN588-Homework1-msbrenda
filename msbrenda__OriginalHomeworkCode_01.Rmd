...
str(df)
```
I think your code was overwall very good! I would try to keep each challenge to a single coding block because it is easier to read and you can just use # to comment inside the code. Aside from that I didn't see any issues and I had similar methods and answers. Good Job!